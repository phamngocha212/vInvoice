...
<form method="post" action="/PsvTransaction/UploadInvoiceCancelData" id="adminForm" name="adminForm" enctype="multipart/form-data">
    <div class="box-body">
    ...
    <div class="box-footer">
        <div class="element-right">
            ...
            <button class="btn btn-sm btn-default" type="button" onclick="document.location ='/PsvTransaction/Index?TypeTran=<%=Model.TypeTrans%>'">
