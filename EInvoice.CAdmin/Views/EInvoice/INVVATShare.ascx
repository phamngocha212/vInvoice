...
<div class="box">
    ...
    <div class="frm-header">
        <div class="left">
            <div class="line">
                ...
                <div class="control"><%= Html.Label("Name", Model.Name.ToUpper())%></div>
            </div>
            <div class="line">
    ...
    <div class="line">
        <div class="label w120"><%: Html.LabelFor(m => m.MaBA, labelText: "Mã bệnh án") %></div>
        <div class="control"><%: Html.TextBoxFor(m => m.MaBA)%></div>
    </div>
    <div class="line">
        <div class="label w120"><%: Html.LabelFor(m => m.Buyer, labelText: "Họ tên người mua hàng") %></div>
        <div class="control"><%: Html.TextBox("Buyer", Model.Buyer, new { maxlength="150"})%></div>
    </div>
    <div class="left w70p">
        <div class="line">
            <div class="label imp" style="width: 130px;"><%: Html.LabelFor(m => m.CusName, labelText: "Tên đơn vị mua") %></div>
            <div class="control"><%: Html.TextBoxFor(m => m.CusName, new { @required = "required", maxlength="150" })%></div>
        </div>
    </div>
    ...
    <div class="left w50p">
        <div class="line">
            ...
            <div class="control">
                <%= Html.TextBox("CusPhone", Model.CusPhone, new { @maxlength = 20, @class = "number" }) %>
            </div>
        </div>
    </div>
    <div class="right">
        <div class="line">
            ...
            <div class="control">
                <%= Html.TextBoxFor(m => m.CusCode, new { maxlength="50"})%>
            </div>
        </div>
    </div>
    <div class="line">
