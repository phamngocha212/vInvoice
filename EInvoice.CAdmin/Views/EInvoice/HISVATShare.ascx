...
<div class="box">
    ...
    <div class="frm-header">
        <div class="left">
            ...
            <div class="line">
                <div class="label w120 imp"><%: Html.LabelFor(m => m.SoPT, labelText: "Số phiếu thu") %></div>
                <div class="control"><%= Html.TextBox("SoPT", Model.SoPT, new { @required = "required" })%></div>
            </div>            
        </div>
        <div class="line">
            <div class="label w90">
    ...
    <div class="line w120">
        ...
        <div class="control">
            ...
            <%: Html.TextBox("Amount", Model.Amount, new { @readonly = "readonly", @class="_number", @tabindex = -1  }) %>
        </div>
    </div>
    <div class="line w120">
        <div class="label">
