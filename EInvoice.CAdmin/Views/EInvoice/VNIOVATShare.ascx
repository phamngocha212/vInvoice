<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<HISInvoice>" %>
...
<div class="box">
    ...
    <div class="line">
        <div class="label w120 imp"><%: Html.LabelFor(m => m.CusName, labelText: "Họ tên người mua hàng, Tên đơn vị") %></div>
