...
<%Html.RenderPartial("DecisionShareElement", Model); %>      
     <div class="text-center">
        <br />
          <button class="btn btn-primary btn-sm" type="button" onclick="Save_Click()"><i class="fa fa-save"></i>Lưu</button>
  ...
  <script language="javascript" type="text/javascript">
      function Save_Click() {
          $("#MainForm").attr("action", "/Publish/EditDecision");
          // alert("before button save");
          $("#MainForm").submit();
          // alert("after button save");
      }
  </script>
</asp:Content>
