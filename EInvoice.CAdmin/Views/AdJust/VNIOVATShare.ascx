...
<div class="box">
    ...
    <div class="left w70p">
        <div class="line">
            ...
            <div class="control"><%: Html.TextBoxFor(m => m.CusName, new { maxlength="200", required="required" })%></div>
        </div>
    </div>
    <div class="right">
        <div class="line">
            <div class="label w80"><%: Html.LabelFor(m => m.CusCode, labelText: "Mã bệnh nhân") %></div>
            <div class="control">
                <%: Html.TextBoxFor(m => m.CusCode, new { @maxlength = 20})%>
            </div>
        </div>
    </div>
    <div class="line">
...
<script type="text/javascript">
    ...
    function bindEvents2Table() {
        ...
        $('table.products tbody .amount').change(function () {
            ...
            if (_vatrate > 0) {
                $('#VATAmount').val(_vatamount.format(0, 3));
                Amount = parseFloat(_totalamount + _vatamount);
            }
            else {
                $('#VATAmount').val('0');
                Amount = _totalamount;
